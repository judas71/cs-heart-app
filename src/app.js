...
React.useEffect(() => {
  ...
  try {
    ...
    return h(
      ...
      activeView === "sportivi" && h(AthletesView, { athletes: state.athletes, fees: state.fees, otherPayments: state.otherPayments || [], taxPayments: state.taxPayments || [], onAdd: addAthlete, onUpdate: updateAthlete, onDelete: deleteAthlete, onNavigate: setActiveView }),
